 ...
 */
export function logInvariantViolation(args) {
  emitConsole({
    ts: isoNow(),
 ...
 */
export function logContractFailure(args) {
  emitConsole({
    ts: isoNow(),
 ...
 */
export function logDriftFlag(args) {
  emitConsole({
    ts: isoNow(),
    category: "DRIFT_FLAG",
 ...
 */
export function logTestFailure(args) {
  emitConsole({
    ts: isoNow(),
 ...
 */
export function assertInvariant(condition, event) {
  if (!condition) {
